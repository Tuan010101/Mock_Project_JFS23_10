	...
	<div class="container">
		<div
			...
			<div class="col-md-9 ftco-animate text-center">
				<p class="breadcrumbs">
					<span class="mr-2"><a
						href="${pageContext.request.contextPath}/">Home</a></span> <span>Contact
						us</span>
				</p>
	...
	<div class="container">
		<div class="row d-flex mb-5 contact-info">
			...
			<div class="col-md-3 d-flex">
				<div class="info bg-white p-4 text-center">
					<p>
						<span>Address:</span> </br> <a
							href="https://maps.app.goo.gl/bmLhAPBPAP1HmA6T7">FPT Complex
							Building, Da Nang City</a>
					</p>
				</div>
			</div>
			<div class="col-md-3 d-flex">
		...
		<div class="row block-9">
			<div class="col-md-6 order-md-last d-flex">
				<form:form action="" method="POST" class="bg-white p-5 contact-form"
					modelAttribute="contact" onsubmit="disableSubmitButton()">
					...
					<div class="form-group">
						<form:textarea name="" id="" cols="30" rows="7"
							class="form-control" path="message" placeholder="Message"></form:textarea>
