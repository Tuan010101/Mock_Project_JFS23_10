				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="ftco-nav">
						<ul class="navbar-nav ml-auto">
							<li class="nav-item active"><a href="${pageContext.request.contextPath}/index"
							...
							<li class="nav-item"><a href="${pageContext.request.contextPath}/shop"
							...
							<li class="nav-item cta cta-colored"><a href="${pageContext.request.contextPath}/cart"
							...
							<c:if test="${pageContext.request.userPrincipal.name == null}">
								<li class="nav-item d-flex">
									...
									<a href="${pageContext.request.contextPath}/register"
										class="nav-link pl-0">Register</a>
								</li>
							</c:if>
							<c:if test="${pageContext.request.userPrincipal.name != null}">
								<li class="nav-item d-flex">
									<span href="${pageContext.request.contextPath}/login"
										class="nav-link pr-0">${pageContext.request.userPrincipal.name }</span>
									<div class="nav-link pr-1 pl-1">|</div>
